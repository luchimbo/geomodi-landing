...
export default function PricingPage() {
	...
	const plans = [
		...
		},
		{
			name: "PRO",
			description:
				"Para tiendas que quieren aparecer y mantenerse visibles en IA",
			...
			<div className="min-h-screen bg-gradient-to-br from-[#F5F3FF] via-[#F0FDF4] to-[#F5F3FF] text-[#1A0B5E] font-sans selection:bg-emerald-200 selection:text-emerald-900 overflow-x-hidden">
				...
				<main className="relative pt-32 pb-20 px-4">
					...
					<div className="relative z-10 max-w-5xl mx-auto text-center">
						...
						>
							Planes que se adaptan al tamaño de tu tienda y a cada etapa de
							crecimiento.
						</motion.p>
									...
									<div className="p-10 md:p-12 flex flex-col flex-1 text-left relative z-10 min-h-[600px]">
										<div className="mb-0">
											<div className="mb-8 min-h-[90px]">
												...
												<h2 className="text-4xl font-bold font-space mt-1">
													{plan.name}
												</h2>
											</div>
										...
										<div className="space-y-10 mb-10 flex-1">
											<div className="min-h-[60px]">
												<h4 className="text-sm font-bold uppercase tracking-wider mb-2 opacity-60">
													Créditos
												</h4>
												<p className="text-[#1A0B5E] text-lg font-medium font-space">
													{plan.credits}
												</p>
											</div>
											<div className="min-h-[100px]">
												...
												<p className="text-[#1A0B5E] text-lg font-medium font-space leading-tight">
													{plan.includes}
												</p>
												{plan.note ? (
											...
											<div>
												...
												<p className="text-3xl font-bold font-space leading-none">
													{plan.price}
												</p>
											</div>
										</div>
				...
				<footer className="py-12 px-4 text-center text-sm text-[#3E3E70]/40">
					© {new Date().getFullYear()} GeoModi • Inteligencia Generativa para
					Marcas
				</footer>
			</div>
		</LazyMotion>
