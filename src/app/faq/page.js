...
import { useReducedMotion, LazyMotion, domMax, motion, AnimatePresence } from "framer-motion";
import { ChevronDown, HelpCircle, Shield, Zap, Target, DollarSign, Lock } from "lucide-react";
...
function FAQItem({ question, answer, isOpen, onClick }) {
    return (
        <div className="border-b border-white/10 last:border-0">
            ...
            >
                <span className={`text-lg md:text-xl font-medium font-space pr-8 transition-colors ${isOpen ? "text-emerald-300" : "text-white group-hover:text-emerald-200"}`}>
                    {question}
                </span>
                <motion.div
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-white/60 font-light max-w-2xl mx-auto">
                                Todo lo que necesitas saber sobre cómo GEOMODI transforma tu presencia en la IA.
                            </p>
                        </motion.div>
                        ...
                        >
                            <h3 className="text-2xl md:text-3xl font-bold font-space mb-4">¿Tenés más dudas?</h3>
                            <p className="text-white/60 text-lg mb-8 max-w-xl mx-auto">
                                Estamos acá para ayudarte a escalar tu tienda con la tecnología de IA más avanzada.
                            </p>
                            <motion.button
