...
export const metadata = {
	...
	description:
		"Optimiza la visibilidad de tu marca en la era de la IA generativa. Transforma tu catálogo de TiendaNube para que ChatGPT, Gemini y Claude te recomienden.",
	keywords: [
		"GEO",
	...
	metadataBase: new URL("https://geomodi.ai"),
	alternates: {
		canonical: "/",
	},
	openGraph: {
		...
		description:
			"La tecnología que traduce tu e-commerce al idioma de la IA. Aparece en las respuestas de ChatGPT y Gemini.",
